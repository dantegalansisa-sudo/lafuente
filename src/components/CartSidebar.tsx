          ...
          >
            ...
            {items.length === 0 ? (
              ...
              <>
                ...
                <div className="cart-sidebar__notice" role="note">
                  ...
                  <p>
                    Los precios mostrados son <strong>referenciales</strong>. El precio final será confirmado por nuestro agente de venta al momento de procesar tu cotización por WhatsApp.
                  </p>
                </div>

                <div className="cart-sidebar__footer">
                  <div className="cart-sidebar__total">
                    <span className="cart-sidebar__total-label">Total estimado</span>
